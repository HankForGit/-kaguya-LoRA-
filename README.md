...
bullet
•	Fine-tuned Qwen 3.6-4B with LoRA to imitate Kaguya’s speaking style, building a full pipeline from data collection and cleaning to training and inference.
